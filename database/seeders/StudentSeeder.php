...
class StudentSeeder extends Seeder
{
    ...
    private array $occupations  = ['Businessman', 'Farmer', 'Teacher', 'Driver', 'Engineer', 'Doctor', 'Trader', 'Government Employee'];
    private array $areas        = ['Freetown', 'Bo', 'Kenema', 'Makeni', 'Koidu', 'Lunsar', 'Port Loko', 'Waterloo'];
