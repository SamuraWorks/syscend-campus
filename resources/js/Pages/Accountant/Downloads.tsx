...
export default function AccountantDownloads({ linked, documents }: Props) {
    if (!linked) {
        return (
                            ...
                            <Card key={doc.id}>
                                <CardContent className="p-4">
                                    <div className="flex items-center gap-4">
                                        ...
                                        <button className="shrink-0 w-9 h-9 rounded-lg bg-emerald-50 dark:bg-emerald-900/30 flex items-center justify-center text-emerald-600 dark:text-emerald-400 hover:bg-emerald-100 dark:hover:bg-emerald-900/50 transition-colors">
