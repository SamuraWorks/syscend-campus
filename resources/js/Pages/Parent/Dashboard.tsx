                ...
                <div className="bg-slate-50 dark:bg-slate-800/50 rounded-lg p-3">
                    ...
                    <div className="flex items-center justify-between">
                        <div>
                            ...
                            <p className="font-semibold text-green-600">Le {child.fees.total_paid.toLocaleString()}</p>
                        </div>
                        <div className="text-right">
                            <p className="text-xs text-slate-500">Balance Due</p>
                            <p className={cn('font-semibold', child.fees.balance > 0 ? 'text-red-600' : 'text-green-600')}>
                                {child.fees.balance > 0 ? `Le ${child.fees.balance.toLocaleString()}` : 'Clear'}
                            </p>
                        </div>
                    </div>
                        ...
                        {totalDue > 0 ? (
                            <div className="flex items-center gap-2 bg-white/20 rounded-lg px-3 py-2">
                                ...
                                <div>
                                    ...
                                    <p className="font-bold">Le {totalDue.toLocaleString()}</p>
                                </div>
                            </div>
                        ) : (
                            <div className="flex items-center gap-2 bg-white/20 rounded-lg px-3 py-2">
