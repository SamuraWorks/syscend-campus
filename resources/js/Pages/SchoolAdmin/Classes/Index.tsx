                        ...
                        <TableBody>
                            {classes.length === 0 ? (
                                ...
                                <TableRow key={c.id}>
                                    ...
                                    <TableCell className="hidden sm:table-cell text-sm text-slate-500">{c.subjects_count ?? 0}</TableCell>
                                    <TableCell className="hidden sm:table-cell text-sm text-slate-500">{c.capacity || '—'}</TableCell>
                                    <TableCell>
