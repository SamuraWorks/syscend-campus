                ...
                <div className="grid grid-cols-2 gap-4 max-w-sm">
                    ...
                    <Card className="border-slate-200 dark:border-slate-800">
                        <CardContent className="p-4 flex items-center gap-3">
                            ...
                            <div>
                                <p className="text-xl font-bold text-red-600">Le {summary.total_outstanding?.toLocaleString()}</p>
                            ...
                            <TableBody>
                                {outstanding.map((row, idx) => (
                                    <TableRow key={row.student.id} className="bg-red-50/30 dark:bg-red-950/5">
                                        ...
                                        <TableCell className="text-right text-sm text-slate-700 dark:text-slate-300">Le {row.total_due.toLocaleString()}</TableCell>
                                        <TableCell className="text-right text-sm text-green-600">Le {row.total_paid.toLocaleString()}</TableCell>
                                        <TableCell className="text-right font-bold text-red-600">Le {row.balance.toLocaleString()}</TableCell>
                                        <TableCell>
