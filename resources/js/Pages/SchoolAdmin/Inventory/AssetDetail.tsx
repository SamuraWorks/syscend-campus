                ...
                <div className="rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-950 p-6">
                    <div className="grid grid-cols-2 sm:grid-cols-3 gap-6">
                        {[
                            ...
                            { label: 'Purchase Price',value: `Le ${Number(asset.purchase_price).toLocaleString()}` },
                            { label: 'Current Value', value: `Le ${Number(asset.current_value).toLocaleString()}` },
                            ...
                            <TableBody>
                                {asset.maintenance_logs.length === 0 ? (
                                    ...
                                    <TableRow key={log.id}>
                                        ...
                                        <TableCell className="text-right text-sm font-medium">Le {Number(log.cost).toLocaleString()}</TableCell>
