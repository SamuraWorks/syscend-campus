        ...
        <AppLayout title="Assets">
            <div className="space-y-6">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                    {[
                        { label: 'Total Value', value: `Le ${stats.total_value.toLocaleString()}`, color: 'text-indigo-600', icon: DollarSign },
                        ...
                        <TableBody>
                            {assets.data.length === 0 ? (
                                ...
                                <TableRow key={a.id}>
                                    ...
                                    <TableCell className="text-right text-sm text-slate-500">Le {Number(a.purchase_price).toLocaleString()}</TableCell>
                                    <TableCell className="text-right font-semibold text-sm text-slate-900 dark:text-white">Le {Number(a.current_value).toLocaleString()}</TableCell>
                                    <TableCell>
