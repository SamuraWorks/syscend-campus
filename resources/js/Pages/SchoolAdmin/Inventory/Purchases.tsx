                        ...
                        <TableBody>
                            {purchases.data.length === 0 ? (
                                ...
                                <TableRow key={p.id}>
                                    ...
                                    <TableCell className="text-right text-sm text-slate-500">Le {Number(p.unit_price).toLocaleString()}</TableCell>
                                    <TableCell className="text-right font-semibold text-sm text-slate-900 dark:text-white">Le {Number(p.total_price).toLocaleString()}</TableCell>
                                </TableRow>
                            ))}
                        </TableBody>
                    </Table>
                ...
                <DialogContent className="sm:max-w-md">
                    ...
                    <div className="space-y-4 mt-2">
                        ...
                        <div className="grid grid-cols-2 gap-3">
                            ...
                            <div className="space-y-1.5">
                                <Label>Unit Price (Le) <span className="text-red-500">*</span></Label>
                        ...
                        {(form.quantity && form.unit_price) && (
                            <div className="rounded-lg bg-slate-50 dark:bg-slate-900 px-4 py-2 flex justify-between text-sm">
                                ...
                                <span className="font-bold text-slate-900 dark:text-white">Le {total}</span>
                            </div>
                        )}
                        <div className="space-y-1.5">
