                        ...
                        <TableBody>
                            {books.data.length === 0 ? (
                                ...
                                <TableRow key={b.id}>
                                    ...
                                    <TableCell className="hidden md:table-cell text-slate-600 dark:text-slate-400 text-sm">{b.author}</TableCell>
                                    <TableCell className="hidden lg:table-cell">
                                        {b.category && <Badge className="bg-indigo-100 text-indigo-700 border-0 text-xs">{b.category}</Badge>}
                                    </TableCell>
                                    <TableCell className="hidden md:table-cell font-mono text-xs text-slate-500">{b.isbn ?? '—'}</TableCell>
                                    <TableCell className="hidden md:table-cell text-slate-500 text-sm">{b.location ?? '—'}</TableCell>
