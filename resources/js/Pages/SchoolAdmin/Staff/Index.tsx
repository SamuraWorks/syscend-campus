                    ...
                    <Table>
                        <TableHeader>
                            <TableRow className="bg-slate-50 dark:bg-slate-900">
                                ...
                                <TableHead className="hidden sm:table-cell">Emp ID</TableHead>
                        ...
                        <TableBody>
                            {staff.data.length === 0 ? (
                                ...
                                <TableRow key={s.id}>
                                    ...
                                    <TableCell className="hidden sm:table-cell font-mono text-xs text-slate-600 dark:text-slate-400">{s.emp_id}</TableCell>
                                    <TableCell className="hidden md:table-cell text-slate-600 dark:text-slate-400 text-sm">{s.department?.name ?? '—'}</TableCell>
                                    <TableCell className="hidden md:table-cell text-slate-600 dark:text-slate-400 text-sm">{s.designation?.name ?? '—'}</TableCell>
                                    <TableCell className="hidden lg:table-cell text-slate-600 dark:text-slate-400 text-sm">{s.phone ?? '—'}</TableCell>
