                    ...
                    <Table>
                        <TableHeader>
                            <TableRow className="bg-slate-50 dark:bg-slate-900">
                                ...
                                <TableHead className="hidden md:table-cell text-center">Capacity</TableHead>
                                <TableHead>Driver</TableHead>
                                <TableHead className="hidden md:table-cell text-center">Routes</TableHead>
                        ...
                        <TableBody>
                            {vehicles.data.length === 0 ? (
                                ...
                                <TableRow key={v.id}>
                                    ...
                                    <TableCell className="hidden md:table-cell text-sm text-slate-500 capitalize">{v.type}</TableCell>
                                    <TableCell className="hidden md:table-cell text-center text-sm">{v.capacity}</TableCell>
                                    <TableCell>
                                    ...
                                    <TableCell className="hidden md:table-cell text-center text-sm text-slate-500">{v.routes_count}</TableCell>
                                    <TableCell>
