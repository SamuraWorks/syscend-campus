            ...
            <div className="space-y-6">
                ...
                <div className="rounded-xl bg-gradient-to-r from-indigo-600 to-violet-600 p-6 text-white flex items-center gap-5">
                    ...
                    <div className="flex-1 min-w-0">
                        ...
                        {student.guardian && (
                            <p className="text-white/70 text-xs mt-0.5">Guardian: {student.guardian.name} &middot; {student.guardian.phone}</p>
                        )}
                    </div>
                    ...
                    <Card>
                        <CardContent className="p-4 flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-xs text-slate-400">{attendance.absent} absent &middot; {attendance.late} late</p>
                            </div>
                        </CardContent>
                    </Card>
                    ...
                    <Card>
                        <CardContent className="p-4">
                            ...
                            <p className={cn('text-xl font-bold', fees.balance > 0 ? 'text-red-600' : 'text-green-600')}>
                                {fees.balance > 0 ? `Le${fees.balance.toLocaleString()} due` : 'Paid up'}
                            </p>
                            <p className="text-xs text-slate-400 mt-0.5">Paid: Le{fees.total_paid.toLocaleString()}</p>
                        </CardContent>
                    </Card>
                            ...
                            <CardContent>
                                {timetableToday.length === 0 ? (
                                    <div className="flex flex-col items-center py-8">
                                        <Calendar className="w-10 h-10 text-slate-200 dark:text-slate-700 mb-2" />
                                        ...
                                        {fees.recent.map(f => (
                                            <div key={f.id} className="flex items-center justify-between p-3 rounded-lg bg-slate-50 dark:bg-slate-800/50">
                                                ...
                                                <div className="text-right">
                                                    <p className="text-sm font-semibold text-slate-800 dark:text-slate-200">Le{f.paid.toLocaleString()}</p>
                                                    {f.balance > 0 && <p className="text-xs text-red-500">Le{f.balance.toLocaleString()} due</p>}
                                                </div>
                    ...
                    <div className="lg:col-span-2 space-y-6">
                        ...
                        <Card>
                            ...
                            <CardContent>
                                {exams.length === 0 ? (
                                    <div className="flex flex-col items-center py-8">
                                        <BookOpen className="w-10 h-10 text-slate-200 dark:text-slate-700 mb-2" />
                                        ...
                                        {exams.map(e => (
                                            <li key={e.id} className="flex items-start gap-3">
                                                ...
                                                <div className="min-w-0">
                                                    ...
                                                    <p className="text-xs text-slate-400">{e.start_date} &middot; {e.type}</p>
                                                </div>
                                            </li>
                                        ))}
                                    </ul>
                        ...
                        <Card>
                            ...
                            <CardContent>
                                {homework.length === 0 ? (
                                    <div className="flex flex-col items-center py-8">
                                        <ClipboardList className="w-10 h-10 text-slate-200 dark:text-slate-700 mb-2" />
                        ...
                        <Card>
                            ...
                            <CardContent>
                                {announcements.length === 0 ? (
                                    <div className="flex flex-col items-center py-8">
                                        <Bell className="w-10 h-10 text-slate-200 dark:text-slate-700 mb-2" />
