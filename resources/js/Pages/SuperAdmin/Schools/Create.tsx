...
const schema = z.object({
    ...
    country:  z.string().default('SL'),
    timezone: z.string().default('Africa/Freetown'),
...
export default function CreateSchool() {
    ...
    const { register, handleSubmit, setValue, watch, setError, formState: { errors, isSubmitting } } =
        useForm<FormData>({
            ...
            defaultValues: { country: 'SL', timezone: 'Africa/Freetown', currency: 'SLL', language: 'en', status: 'active' },
        });
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                    ...
                    <Card className="dark:bg-slate-900 border-slate-200 dark:border-slate-800">
                        ...
                        <CardContent className="grid grid-cols-2 gap-4">
                            ...
                            <Field name="city" label="City" placeholder="Freetown" />
                            <Field name="state" label="State / Province" placeholder="Western Area" />
                        </CardContent>
                    </Card>
                    ...
                    <Card className="dark:bg-slate-900 border-slate-200 dark:border-slate-800">
                        ...
                        <CardContent className="grid grid-cols-3 gap-4">
                            ...
                            <div className="space-y-1.5">
                                ...
                                <Select defaultValue="SLL" onValueChange={(v) => setValue('currency', v)}>
                                    <SelectTrigger className="h-9"><SelectValue /></SelectTrigger>
                                    <SelectContent>
                                        <SelectItem value="SLL">SLL (Leones)</SelectItem>
