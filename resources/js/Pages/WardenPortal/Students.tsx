...
interface Student {
    ...
    class: string; phone: string | null;
                    ...
                    <CardContent className="p-0">
                        <Table>
                            ...
                            <TableBody>
                                {students.length === 0 ? (
                                    <TableRow>
                                        <TableCell colSpan={6} className="text-center py-8 text-slate-400">No students in hostel.</TableCell>
                                    </TableRow>
                                ) : (
                                    students.map(s => (
                                        <TableRow key={s.id}>
                                            ...
                                            <TableCell className="text-xs">{s.bed_no ?? '—'}</TableCell>
